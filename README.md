# Supervised Transactions Decentralized System

## Overview

This project is a mobile-first web application that enables distribution of virtual points between registered **Customers** using digital signatures, without a centralized verification system.
